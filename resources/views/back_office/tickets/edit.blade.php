                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="card">
                                ...
                                <div class="card-block">
                                    <form action="{{ route('back_office.tickets.update',$ticket->id) }}" method="post" class="form-horizontal "
                                        enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        @include('layouts._error')
                                        <input type="hidden" name="back_office_id" value="{{ Auth::id() }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text"  id="ticket_source" name="ticket_source"
                                                    class="form-control" value="{{ $ticket->ticket_source }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        @else
                                        <div class="card-footer">
                                            <a href="{{ route('back_office.tickets.index') }}" class="btn btn-sm btn-primary"><i
                                                    class="fa fa-home"></i>
                                                عودة</a>
                                        </div>
                                        @endif
