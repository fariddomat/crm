    ...
    <main class="main">
        ...
        <div class="container-fluid">
            ...
            <div class="animated fadeIn">
                <a href="{{ route('back_office.tickets.create') }}" class="btn btn-primary">تذكرة جديدة <i class="fa fa-edit"></i></a>
                        ...
                        <table class="table table-striped ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('back_office.profiles.show', $profile->id) }}" class="btn btn-success btn-sm"><i class="fa fa-ticket"></i></a>
                                    </td>
                                </tr>
                                @endforeach
