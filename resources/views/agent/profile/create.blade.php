                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                                <form action="{{ route('agent.tickets.newTicket') }}" method="post" class="form-horizontal ">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-2 form-control-label" for="">رقم الهوية (اختياري)</label>
                                        <div class="col-md-8">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" id="aou_number" name="aou_number" class="form-control">
                                        </div>
                                    </div>
