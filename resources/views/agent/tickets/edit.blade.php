                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="card">
                                ...
                                <div class="card-block">
                                    <form action="{{ route('agent.tickets.update',$ticket->id) }}" method="post" class="form-horizontal "
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-2 form-control-label" for="">نوع التذكرة</label>
                                            <div class="col-md-8">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-2 form-control-label" for="">حالة التذكرة</label>
                                            <div class="col-md-8">
                                                <select name="status" id="" class="form-control">
                                                    {{-- <option value="open">مفتوحة</option> --}}
                                                    <option value="progress">تحويل للمسؤول</option>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-2 form-control-label" for="">مصدر التذكرة</label>
                                            <div class="col-md-8">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-2 form-control-label" for="">ملاحظات</label>
                                            <div class="col-md-8">
                                        ...
                                        @else
                                        <div class="card-footer">
                                            <a href="{{ route('agent.tickets.index') }}" class="btn btn-sm btn-primary"><i
                                                    class="fa fa-home"></i>
                                                عودة</a>
                                        </div>
                                        @endif
