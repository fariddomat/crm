                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                                <form action="{{ route('supervisor.tickets.update', $ticket->id) }}" method="post"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" id="comments" name="comments" class="form-control"
                                                value="{{ $ticket->comments }}" disabled>
                                        </div>
                                    </div>

                                    @if ($ticket->status == 'progress')
                                        <div class="form-group row">
                                            <label class="col-md-3 form-control-label" for="">تحديد Back
                                                Office</label>
                                            <div class="col-md-8">
                                                <select name="back_office_id" id="" class="form-control">
                                                    @foreach ($back_offices as $item)
                                                        <option value="{{ $item->id }}"
                                                            @if ($ticket->back_office_id == $item->id) selected @endif>
                                                            {{ $item->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            @foreach ($ticket->ticket_attachments as $index => $item)
                                                <a href="/files/{{ $ticket->id }}/{{ $item->file }}"><img
                                                        class="col-md-4"
                                                        src="/files/{{ $ticket->id }}/{{ $item->file }}"
                                                        alt="File {{ $index + 1 }}"></a>
                                            @endforeach
                                        </div>
                                    </div>
                                    ...
                                    @else
                                        <div class="card-footer">
                                            <a href="{{ route('supervisor.tickets.index') }}"
                                                class="btn btn-sm btn-primary"><i class="fa fa-home"></i>
                                                عودة</a>
                                        </div>
                                    @endif
                                </form>
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                                <form class="form-horizontal ">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 form-control-label" for="">الجنسية
                                            (اختياري)</label>
                                        <div class="col-md-8">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 form-control-label" for="">البريد
                                            الإلكتروني</label>
                                        <div class="col-md-8">
