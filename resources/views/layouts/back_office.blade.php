 ...
 <body class="navbar-fixed sidebar-nav fixed-nav">
     ...
     <div class="sidebar">
         <nav class="sidebar-nav">
             <ul class="nav">
                 <li class="nav-item">
                     <a class="nav-link" href="{{ route('back_office.home') }}"><i class="icon-speedometer"></i> لوحة التحكم </a>
                 </li>
                 ...
                 <li class="nav-item nav-dropdown">
                     ...
                     <ul class="nav-dropdown-items">
                         ...
                         <li class="nav-item">
                             <a class="nav-link" href="{{ route('back_office.tickets.index') }}"><i class="icon-puzzle"></i> تحتاج مراجعة</a>
                         </li>
                         <li class="nav-item">
                            <a class="nav-link" href="{{ route('back_office.tickets.index') }}?filter=all"><i class="icon-puzzle"></i> كل التذاكر</a>
                        </li>
                     </ul>
                 </li>
                 <li class="nav-item">
                 ...
                 <li class="nav-item">
                    <a class="nav-link" href="{{ route('back_office.myProfile') }}"><i class="icon-lock"></i> الملف الشخصي </a>
                </li>
             </ul>
         </nav>
     </div>
